...
const { verifyToken, verifyHeartbeatAuth, authorizeRoles } = require('../middlewares/auth.middleware');
...
router.post('/heartbeat', verifyHeartbeatAuth, androidController.androidHeartbeat);
